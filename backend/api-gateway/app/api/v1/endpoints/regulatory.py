...
MOCK_UPDATES = [
    {
        "authority": "imns",
        "title": "Изменение ставки УСН для ИП",
        "summary": "С 01.01.2026 ставка УСН для индивидуальных предпринимателей, оказывающих услуги, снижена с 6% до 5%. "
                   "Для ИП, осуществляющих розничную торговлю — ставка остаётся 3%.",
