...
| **Спринт 12.** Госпорталы | Интеграция с порталами, ЭЦП, статусы, архив | Частично: мок-пайплайн [`report_submission.py`](../../backend/api-gateway/app/api/v1/endpoints/report_submission.py), UI **Настройки → Подача отчётов** [`SettingsPage.tsx`](../../frontend/web/src/pages/SettingsPage.tsx). Реальных API порталов и ЭЦП нет. |
