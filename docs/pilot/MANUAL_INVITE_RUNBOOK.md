...
3. Указать email, роль (`accountant` / `viewer`).
4. Если email не отправился — скопировать **ссылку приглашения** кнопкой «Ссылка» в списке ожидающих или из сообщения после создания invite.
