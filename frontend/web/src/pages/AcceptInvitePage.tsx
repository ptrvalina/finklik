...
export default function AcceptInvitePage() {
  ...
  return (
    <AuthLayout maxWidthClass="max-w-md">
      ...
      <div className="card-elevated relative overflow-hidden rounded-3xl border border-outline/60 p-8 shadow-float ring-1 ring-primary/[0.08] backdrop-blur-xl dark:border-white/[0.08]">
